#!/usr/bin/env python3
"""Process a single month of raingauge data from STFC variant."""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Process a single month of RAL Drop Counting Gauge raingauge data from STFC variant.",
    )
